...
export default defineConfig({
  title: "¯\\_(ツ)_/¯",
  description: "Konstantin Azizov's blog",
  titleTemplate: "Konstantin Azizov",
  head: [
    [
      "link",
      {
    ...
    sidebar: [
      {
        items: [
          {
            text: "Lessons from AI-assisted migration",
            link: "/blog/biome-migration",
          },
        ],
      },
    ],
